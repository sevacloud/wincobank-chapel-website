    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6">
        <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-5">
          ...
          <p className="text-sm text-indigo-700 font-medium mb-2">11am – 12 noon</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-indigo-700 font-medium mb-2">Tuesdays 9:45 – 10:45am</p>
          <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-indigo-700 font-medium mb-2">Wednesdays 10am – 12 noon</p>
          <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-indigo-700 font-medium mb-2">Thursdays 11am – 12 noon</p>
          <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-indigo-700 font-medium mb-2">By arrangement</p>
          <p className="text-gray-600 text-sm">
